...
public class projectSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case projectPackage.VIEW_GROUP: {
			Element viewGroup = (Element) theEObject;
			T result = caseViewGroup(viewGroup);
			if (result == null)
				result = caseElement(viewGroup);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case projectPackage.VIEW: {
		...
		case projectPackage.EDIT_TEXT: {
			...
			if (result == null)
				result = caseView(editText);
			if (result == null)
				result = caseElement(editText);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case projectPackage.ELEMENT: {
	 ...
	 * @generated
	 */
	public T caseViewGroup(Element object) {
		return null;
	}
