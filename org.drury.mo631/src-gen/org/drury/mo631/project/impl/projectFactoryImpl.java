...
public class projectFactoryImpl extends EFactoryImpl implements projectFactory {
	...
	public EObject create(EClass eClass) {
		...
		case projectPackage.VIEW_GROUP:
			return createViewGroup();
		case projectPackage.BUTTON:
			return createButton();
		case projectPackage.TEXT_VIEW:
			return createTextView();
		case projectPackage.EDIT_TEXT:
			return createEditText();
		case projectPackage.POSITION:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case projectPackage.POSITION_KIND:
			return createPositionKindFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case projectPackage.POSITION_KIND:
			return convertPositionKindToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 */
	@Override
	public Element createViewGroup() {
		Element viewGroup = (Element) super.create(projectPackage.Literals.VIEW_GROUP);
		return viewGroup;
	}
	 ...
	 * @generated
	 */
	public PositionKind createPositionKindFromString(EDataType eDataType, String initialValue) {
		PositionKind result = PositionKind.get(initialValue);
		if (result == null)
	 ...
	 * @generated
	 */
	public String convertPositionKindToString(EDataType eDataType, Object instanceValue) {
