 ...
 * @generated
 */
public class ViewGroupItemProvider extends ElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(projectPackage.Literals.VIEW_GROUP__VIEWS);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ViewGroup_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case projectPackage.VIEW_GROUP__VIEWS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(projectPackage.Literals.VIEW_GROUP__VIEWS,
				projectFactory.eINSTANCE.createButton()));

		newChildDescriptors.add(createChildParameter(projectPackage.Literals.VIEW_GROUP__VIEWS,
				projectFactory.eINSTANCE.createTextView()));

		newChildDescriptors.add(createChildParameter(projectPackage.Literals.VIEW_GROUP__VIEWS,
				projectFactory.eINSTANCE.createEditText()));
	}
